...
// Data base functions
import { getPizza, updatePizza, createPizza } from "@/api/food";
...
export default function Page() {
        ...
        if (file) {
            handdleFileUpload(file)
                .then((result) => {
                    ...
                    handleCreatePizza(updatedValues);
                })
                .catch((error) => {
    ...
    const handleCreatePizza = (values:any) => {
        console.log("Creating pizza:", values);
        try {
            const create = createPizza(values);
            console.log('Pizza created:', create.then((result) => {
                ...
                <Form {...form}>
                    ...
                    <div className="grid w-full items-center gap-4">
                        ...
                        <div>
                            {file && (
                                <img
                                    src={URL.createObjectURL(file)} // Use URL.createObjectURL to create a local URL
                                    alt="Pizza preview"
                                    className="w-20 h-20"
                                />
                            )}
